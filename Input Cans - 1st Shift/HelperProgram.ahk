...
Sleep, 3000
FormatTime, TimeString, A_now, ddd d-MMM-yy hhmmss tt
...
if (L1Changeover1 = TRUE && L1Running = TRUE)
{
...
if (L1Changeover2 = TRUE && L1Running = TRUE)
{
...
if (L1shutdown = TRUE && L1Running = TRUE)
{
	shutdown()
}
...
if (L2Changeover1 = TRUE && L2Running = TRUE)
{
...
if (L2Changeover2 = TRUE && L2Running = TRUE)
{
...
if (L2shutdown = TRUE && L2Running = TRUE)
{
	shutdown()
}
...
if (L4Changeover1 = TRUE && L4Running = TRUE)
{
...
if (L4Changeover2 = TRUE && L4Running = TRUE)
{
...
if (L4Micro = FALSE && L4Running = TRUE)
{
	NoMicro()
}
if (L4shutdown = TRUE && L4Running = TRUE)
{	
	shutdown()
}
...
if (L5Changeover1 = TRUE && L5Running = TRUE)
{
...
if (L5Changeover2 = TRUE && L5Running = TRUE)
{
...
if (L5Micro = FALSE&& L5Running = TRUE)
{
	NoMicro()
}
if (L5shutdown = TRUE && L5Running = TRUE)
{	
	shutdown()
}
...
if (L6Changeover1 = TRUE && L6Running = TRUE)
{
...
if (L6Changeover2 = TRUE && L6Running = TRUE)
{
	changeover(L2ProductChangeover2)
	Sleep, 10000
...
if (L6Micro = FALSE && L6Running = TRUE)
{
	NoMicro()
}
if (L6shutdown = TRUE && L6Running = TRUE)
{	
	shutdown()
}
...
if (L7Changeover1 = TRUE && L7Running = TRUE)
{
...
if (L7Changeover2 = TRUE && L7Running = TRUE)
{
	changeover(L2ProductChangeover2)
	Sleep, 10000
...
if (L7shutdown = TRUE && L7Running = TRUE)
{	
